/*
  © POLIHOV DEV STUDIO
  Файл: editor.js
  Описание: Логика редактора зон: рисование/редактирование/удаление и сохранение geojson.
*/
...
(function () {
  ...
  function setDrawIconPlus() {
    drawIcon.src = "assets/icons/plus.svg";
  }
  function setDrawIconCheck() {
    drawIcon.src = "assets/icons/check.svg";
  }

  function setEditIconTriangle() {
    editIcon.src = "assets/icons/triangle.svg";
  }
  function setEditIconCheck() {
    editIcon.src = "assets/icons/check.svg";
  }
